...
export default function ConnectModal({ setOpenModal }) {
    return (
        <>
            <div id="crypto-modal" aria-hidden="true" className="fixed inset-0 z-10  mx-auto flex h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden  scroll-smooth pt-16 md:pt-12 ">
                <div className="relative h-full w-full max-w-sm p-4 sm:h-auto">
                    <div className="relative rounded bg-white shadow ">
                        <button
                            ...
                            type="button"
                            className="dark:hover:textWhite absolute top-3 right-2.5 ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-500 hover:bg-gray-300 hover:text-gray-900 "
                        ...
                        <div className="rounded-t border-b py-4 px-6 dark:border-gray-600">
                            <h3 className=" text-base font-semibold text-gray-900 lg:text-xl">Connect to a wallet</h3>
                        </div>
                        <div className="p-6">
                            ...
                            <ul className="my-4 space-y-3">
                                <li>
                                    <a href="#" className="roundedLg dark:textWhite  group flex items-center bg-gray-50 p-3 text-base font-bold text-gray-900 hover:bg-gray-200 hover:shadow ">
                                        ...
                                        <span className="ml-3 inline-flex items-center justify-center rounded border-2 border-white bg-gray-200 px-2 py-0.5 text-xs font-medium text-gray-500 hover:bg-white dark:bg-gray-700 dark:text-gray-400">
                                            Connect
                                        </span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="#" className="roundedLg dark:textWhite group flex items-center bg-gray-50 p-3 text-base font-bold text-gray-900 hover:bg-gray-200 hover:shadow ">
                                        <svg className="h-5" viewBox="0 0 75.591 75.591" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                            <linearGradient id="a" gradientTransform="matrix(0 -54.944 -54.944 0 23.62 79.474)" gradientUnits="userSpaceOnUse" x2="1">
                                                <stop offset="0" stopColor="#ff1b2d"></stop>
                                                <stop offset=".3" stopColor="#ff1b2d"></stop>
                                                <stop offset=".614" stopColor="#ff1b2d"></stop>
                                            ...
                                            <linearGradient id="b" gradientTransform="matrix(0 -48.595 -48.595 0 37.854 76.235)" gradientUnits="userSpaceOnUse" x2="1">
                                                ...
                                                <stop offset=".7" stopColor="#ff4b4b"></stop>
                                                <stop offset="1" stopColor="#ff4b4b"></stop>
                                            </linearGradient>
                                ...
                                <li>
                                    <a href="#" className="roundedLg dark:textWhite group flex items-center bg-gray-50 p-3 text-base font-bold text-gray-900 hover:bg-gray-200 hover:shadow ">
                                        <svg className="h-5" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                            <defs>
                            ...
                            <div>
                                <a href="#" className="inline-flex items-center text-xs font-normal text-gray-500 dark:text-gray-400">
                                    <svg className="mr-2 h-3 w-3" aria-hidden="true" focusable="false" data-prefix="far" data-icon="question-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <path
                                            fill="currentColor"
                                    ...
                                    <span>New here?</span>
                                    {` `}
                                    <span className="text-indigo-500 hover:text-indigo-700 hover:underline">Get started on Geek!</span>
                                </a>
                            </div>
                        </div>
                    </div>
