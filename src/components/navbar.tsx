...
export default function Navbar() {
    ...
    return (
        <div className="fixed top-0 z-20 w-full bg-indigo-600 text-gray-100 transition dark:bg-gray-800">
                ...
                <div className="relative flex h-15 items-center justify-between space-x-4">
                    ...
                    <div className="hidden flex-1 justify-start md:flex">
                        <div className="flex space-x-4">
                            <a className="rounded px-4 py-2 font-normal text-gray-300 transition hover:bg-gray-700 hover:text-white">Swap</a>

                            <a href="https://wiki.geek.gl" className="rounded px-4 py-2 font-normal text-gray-300 transition hover:bg-gray-700 hover:text-white">
                                Staking
                            </a>

                            <a className="rounded px-4 py-2 font-normal text-gray-300 transition hover:bg-gray-700 hover:text-white">Earn</a>
                            <a className="cursor-pointer rounded border border-indigo-500 px-4 py-2 font-normal text-gray-100 transition hover:bg-indigo-500 focus:outline-none focus:ring">Locked</a>
                        </div>
                    </div>
                    ...
                    <div className="ml-3 flex items-center space-x-4">
                        <Menu as="div" className="relative inline-block text-left">
                            <div>
                                <Menu.Button className="inline-flex w-full items-center justify-center rounded bg-white bg-opacity-20 p-2 text-sm transition hover:bg-opacity-50 hover:text-white focus:outline-none focus:ring-2 focus:ring-gray-50 focus:ring-opacity-90">
                        ...
                        {active ? (
                            ...
                            <button onClick={connect} className="ml-3 flex-shrink-0 rounded-md border border-white px-4 py-1.5 transition hover:bg-white hover:bg-opacity-20">
                                {' '}
                                Connect
                            </button>
                        )}
                        ...
                        <Menu as="div" className="relative inline-block">
                            <Menu.Button className="relative flex-shrink-0 rounded-md bg-white bg-opacity-20 p-2 transition hover:bg-opacity-50 hover:text-white focus:outline-none focus:ring-2 focus:ring-gray-50 focus:ring-opacity-90">
                            ...
                            <Transition
                                ...
                                leaveFrom="transform opacity-100 scale-100"
                                leaveTo="transform opacity-0 scale-95">
                                <Menu.Items className="absolute right-0 z-10 mt-2 w-72 origin-top-right divide-y divide-gray-100 rounded-md bg-white text-gray-700 shadow focus:outline-none dark:divide-gray-600 dark:bg-gray-700 dark:text-gray-200">
                                    {/* <div className="py-1">
                                        ...
                                        {isDarkMode ? (
                                            <Menu.Item>
                                                <a onClick={() => setDarkMode(false)} className="group flex cursor-pointer rounded p-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" aria-hidden="true" className="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500" viewBox="0 0 16 16">
